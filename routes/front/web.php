...
Route::group(['namespace' => 'Front'], function () {
    ...
    Route::get('/san-pham/{productSlug}/','FrontController@showProductDetail')->name('front.show-product-detail');
    // Route::get('/load-product-home-page','FrontController@loadProductHomePage')->name('front.load-product-home-page');
    // Route::get('/thiet-bi-dien/{oldParentSlug?}/{parentSlug?}/{categorySlug}/','FrontController@showProductCategory')->name('front.show-product-category');
    Route::prefix('thiet-bi-dien')->group(function () {
        Route::get('{categorySlug}/', 'FrontController@showProductCategory')
            ->name('front.show-product-category');

        Route::get('{parentSlug}/{categorySlug}/', 'FrontController@showProductCategory')
            ->name('front.show-product-category');

        Route::get('{oldParentSlug}/{parentSlug}/{categorySlug}/', 'FrontController@showProductCategory')
            ->name('front.show-product-category');
    });
