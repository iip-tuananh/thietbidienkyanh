...
Route::group(['prefix' => 'admin'], function () {
    ...
    Route::middleware('auth:admin')->group(function () {
        ...
        Route::group(['prefix' => 'categories'], function() {
            ...
            // Import
            // Route::get('/category-import', 'Admin\CategoryController@categoryImport')->name('Category.categoryImport');
        });
        ...
        Route::group(['prefix' => 'products'], function () {
            ...
            // Import
            // Route::get('/product-import', 'Admin\ProductController@productImport')->name('Product.productImport');
        });
