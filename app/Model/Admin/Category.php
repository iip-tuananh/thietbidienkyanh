...
class Category extends BaseModel
{
    ...
    {
        if ($this->categoryParent && $this->categoryParent->categoryParent) {
            $slugs[] = $this->categoryParent->categoryParent->slug;
        }
        if ($this->categoryParent) {
            $slugs[] = $this->categoryParent->slug;
        }
        $slugs[] = $this->slug;
        // $url = url('thiet-bi-dien/' . implode('/', $slugs) . '/');
        $url = rtrim(url('thiet-bi-dien/' . implode('/', $slugs)), '/') . '/';
        return $url;
    }
}
