...
<div class="item_product_main">
    <div class="product-thumbnail">
        <a class="image_thumb scale_hover" href="{{ $product->product_url }}"
            title="{{ $product->name }}">
            <img width="480" height="480" class="lazyload image1"
                src="{{ $product->image ? $product->image->path : 'https://placehold.co/480x480' }}"
                data-src="{{ $product->image ? $product->image->path : 'https://placehold.co/480x480' }}"
                alt="{{ $product->name }}">
        </a>
        <div class="smart">
        ...
        <form class="variants product-action" data-cart-form
            data-id="product-actions-34584461" enctype="multipart/form-data">
            <input type="hidden" name="variantId" value="110011404" />
    ...
    <div class="product-info">
        <h3 class="product-name">
            <a class="line-clamp line-clamp-1" href="{{ $product->product_url }}"
        ...
        {{-- <div class="star_compar">
            <a href="javascript:void(0)" class="setCompare btn-views js-compare-product-add"
                data-compare="toi-treo-chay-tren-dam-hr-yamado" data-type="Máy tời" tabindex="0" title="So sánh">
                <i></i>
            </a>
        </div> --}}
    </div>
